...
| Gate | Command | Status |
|---|---|---|
| Unit + integration suite | `make test` / `make test-w` (warnings as errors) | 857 passing |
...
The full suite (857 tests) runs in about seven seconds, so run it after
every change:
